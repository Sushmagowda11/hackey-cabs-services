...
<div class="container">
    ...
    font-weight: 700;
    text-align: center;
    margin-top: 200px;">Taxi and cabs services -Bangalore cabs, South india cabs | Book Out station Cabs at Best Price </h4>
</div>
            ...
            <div class="col-md-12">
               <div class="x_offer_tabs_wrapper" >
                  <ul class="nav nav-tabs">
                     <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#menu1"> Oneway Trip</a></li>
                     <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu2"> Round Trip</a></li>
                  </ul>
               </div>
               <div class="tab-content">
                     ...
                     <form action="search.php" method="post">
                        <div class="row">
                           ...
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                              <div class="x_slider_form_input_wrapper float_left">
                                 <h3>Contact No</h3>
                                 <input type="text" placeholder="Enter Contact No" maxlength="15" value="+91" required name="number"/>
                              </div>
                           </div>
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                              <div class="x_slider_form_input_wrapper float_left">
                     ...
                     <form action="search.php" method="post">
                        <div class="row">
                           ...
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                              <div class="x_slider_form_input_wrapper float_left">
                                 <h3>Contact No</h3>
                                 <input type="text" placeholder="Enter Contact No" maxlength="15" value="+91" name="number" required/>
                              </div>
                           </div>
                           <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                              <div class="x_slider_form_input_wrapper float_left">
...
<div class="x_why_main_wrapper" id="About">
   ...
   <div class="container">
      ...
      <div class="x_why_right_main_wrapper">
         <h3>About Us</h3>
         <br />
         <p>We have an experienced team of having in-depth information about car rental services , In addition, our team is capable of handling Car rental related problems, be it for the bookings you have made or for any specific transport related issue. In a Bangalore city having such a long list of achievements, a good means of transportation becomes important. For that, you can avail the benefits of taxi service in Indore from Kings Taxi, which is one of the leading providers of cab booking in Karnataka state. The assurance in quality given by kings Taxi with taxi booking in Bangalore is unique and trustworthy. For us, our customer's trust and comfort matter the most and so we provide the best car at the most reasonable price.</p>
         <br/><br/>
      </div>
   </div>
</div>
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
            <div class="btc_team_slider_cont_main_wrapper">
               <div class="btc_ln_img_cont_wrapper float_left" style="
                  ...
                  <p>If you are looking for drop services, then Kings Taxi Rental is the best car rental platform to hire One way taxi at reasonable rates. You can also book one way taxi by calling at +91 9900918011.</p>
               </div>
            </div>
         </div>
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
            <div class="btc_team_slider_cont_main_wrapper">
               <div class="btc_ln_img_cont_wrapper float_left" style="
                  ...
                  <p>Kings Taxi Rental is the best car rental platform to hire Round Trip at reasonable rates. You can also book one way taxi as well as round taxi by calling at +91 9900918011.</p>
               </div>
            </div>
         </div>
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
            <div class="btc_team_slider_cont_main_wrapper">
               <div class="btc_ln_img_cont_wrapper float_left" style="
                  ...
                  <p>We Deliver cost effective, safe, secure and comfortable rides to our clients. You can also book Employee Transportation Solutions by calling at +91 9900918011.</p>
               </div>
            </div>
         </div>
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
            <div class="btc_team_slider_cont_main_wrapper">
               <div class="btc_ln_img_cont_wrapper float_left" style="
                  ...
                  <p>We have special packages for Corporates. Be it First time service or for Company Cars, we can customize our package to suit your requirements. Call Us at +91 9900918011.</p>
               </div>
            </div>
         </div>
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" style="margin-top: 25px;">
                  ...
                  <div>
                     <div class="card  valign-wrapper">
                        ...
                        <div class="card-content center-align valign">
                           ...
                           <!-- Client's Feedback -->
                           <p>“ One of the best taxi I have been ever travelled. They treat customer as very good manner way. While traveling time I felt Safe & Secured this is what all customers want. ”</p>
                           <!-- /Client's Feedback -->
                           <!-- Client's Name -->
                           <p class="card-title">Mahesh B<span>Our Customer</span>
                           </p>
                           <!-- /Client's Name -->
                        </div>
                     </div>
                  ...
                  <div>
                     <div class="card  valign-wrapper">
                        ...
                        <div class="card-content center-align valign">
                           ...
                           <!-- Client's Feedback -->
                           <p>“  The car rental service was extremely punctual and friendly. The driver was very good in behavior as well as driving skill. We got useful suggestions about Route ”</p>
                           <!-- /Client's Feedback -->
                           <!-- Client's Name -->
                           <p class="card-title">Barath S P<span>Our Customer</span>
                           </p>
                           <!-- /Client's Name -->
                        </div>
                     </div>
                  ...
                  <div>
                     <div class="card  valign-wrapper">
                        ...
                        <div class="card-content center-align valign">
                           ...
                           <!-- Client's Feedback -->
                           <p>“ Good comfortable with the Car, Driver's mannerism at the perfect timing of pickup and drop!!  friendly approach and feel comfortable.. quality and punctuality is good ”</p>
                           <!-- /Client's Feedback -->
                           <!-- Client's Name -->
                           <p class="card-title">Manjunath N<span>Our Customer</span>
                           </p>
                           <!-- /Client's Name -->
                        </div>
                     </div>
                  ...
                  <div>
                     <div class="card  valign-wrapper">
                        ...
                        <div class="card-content center-align valign">
                           ...
                           <!-- Client's Feedback -->
                           <p>“ Absolutely - definitely - I will be recommending your services.Thank you for a wonderful journey! " "I was so pleased with the trip. Our driver were outstanding : knowledgeable and friendly.
                              ”
                           </p>
                           <!-- /Client's Feedback -->
                           <!-- Client's Name -->
      ...
      <div class="row">
         ...
         <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="x_cou_main_box_wrapper">
               ...
               <h5><span></span> <a href="#">24x7 Cab Service</a></h5>
         ...
         <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="x_cou_main_box_wrapper">
               ...
               <h5><span></span> <a href="#">Secure Bookings</a></h5>
         ...
         <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="x_cou_main_box_wrapper x_cou_main_box_wrapper_last">
               ...
               <h5><span></span> <a href="#">Friendly Drivers</a></h5>
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 full_width">
                  <div class="x_contact_title_icon_cont_main_box">
                     ...
                     <div class="x_contact_title_icon_cont">
                        ...
                        <p><a href="tel:+91 9900918011" >+91 9900918011</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 full_width">
                  <div class="x_contact_title_icon_cont_main_box">
                     ...
                     <div class="x_contact_title_icon_cont">
                        ...
                        <p><a href="#">info@kingstaxi.in</a></p>
                     </div>
                  </div>
               </div>
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 full_width">
